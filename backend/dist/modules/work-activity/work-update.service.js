...
export async function getUpdates(workItemId) {
...
export async function addUpdate(workItemId, employeeId, updateText, progressPercent) {
    if (!updateText.trim()) {
    ...
    await logActivity(workItemId, employeeId, 'UPDATE_ADDED', `Submitted progress update (${progressPercent}%): ${updateText.trim()}`);
