import { getProjects, createProject, getProjectMembers, addProjectMember, removeProjectMember, } from './project.service.js';
export async function listProjects(req, res) {
    try {
        ...
        const projects = await getProjects(organizationId, req.userId, req.profile.role);
        return res.json({
            success: true,
            data: projects,
        });
...
export async function addProject(req, res) {
    try {
        ...
        const project = await createProject(organizationId, createdBy, req.body);
